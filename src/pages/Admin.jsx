                      ...
                      <tr key={g.id}>
                        ...
                        <td>
                          <div className="admin-table__actions">
                            <button className="admin-action-btn" title="Edit" onClick={() => openEdit(g)}>✏️</button>
                            <button className="admin-action-btn" title="Reset RSVP" onClick={() => handleResetRsvp(g)}>↩️</button>
                            <button className="admin-action-btn admin-action-btn--danger" title="Delete" onClick={() => handleDeleteGuest(g)}>🗑️</button>
                          </div>
                        </td>
                      </tr>
                    ))
